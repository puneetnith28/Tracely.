...
# Tracely Project Standards & Development Guidelines

This document outlines the standards, conventions, and best practices for the Tracely supply chain provenance platform across all three projects: backend, frontend, and mobile.

---

## Project Overview

**Tracely** is a multi-stack supply chain trust & transparency platform with three main components:

1. **Tracely_backend** - Python Flask API for AI-powered image integrity analysis
2. **Tracely_frontend** - React + Vite web application for QR scanning and batch management
3. **app/Tracely_mobile** - React Native/Expo mobile app for field scanning

---

## Technology Stack Summary

### Backend (Tracely_backend)
- **Language:** Python 3.x
...
```json
{ "version": "1.0.0", "description": "Tracely Backend" }
```
...
### Mobile (.env)
```
EXPO_PUBLIC_API_URL=https://Tracely.onrender.com
...
- **Backend Architecture:** See Tracely_backend/README.md for detailed API documentation
